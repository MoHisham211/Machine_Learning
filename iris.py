...
df = pd.read_csv(r'C:\Users\Eng_Mo7amed\Desktop\Projects\iris.csv')
...
# Create training and testing vars, It’s usually around 8020 or 7030.
...
#2print(accuracy_score(Y_test, predictions))
...
pd.to_pickle(model,r'C:\Users\Eng_Mo7amed\Desktop\Projects\Iris\masternew_model.pickle')

# Unpickle model 
model = pd.read_pickle(r'C:\Users\Eng_Mo7amed\Desktop\Projects\Iris\masternew_model.pickle') 
